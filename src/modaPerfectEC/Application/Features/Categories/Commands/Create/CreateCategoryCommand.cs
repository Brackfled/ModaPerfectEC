...
public class CreateCategoryCommand : IRequest<CreatedCategoryResponse>, ISecuredRequest, ITransactionalRequest
{
    ...
    public class CreateCategoryCommandHandler : IRequestHandler<CreateCategoryCommand, CreatedCategoryResponse>
    {
        ...
        {
            await _categoryBusinessRules.CategoryShouldNotExists(request.Name);
