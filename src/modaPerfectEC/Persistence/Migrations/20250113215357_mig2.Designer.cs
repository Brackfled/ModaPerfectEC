            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a4e47536-dfb8-42eb-8e17-6cde3acf7a08"),
                            Address = "Dere",
                            AuthenticatorType = 0,
                            City = "Konya",
                            Country = "Türkiye",
                            ...
                            LastName = "ÖNCEL",
                            PasswordHash = new byte[] { 223, 104, 176, 222, 234, 236, 58, 71, 145, 50, 244, 136, 88, 103, 83, 169, 79, 132, 179, 151, 21, 35, 5, 19, 195, 152, 136, 100, 171, 63, 10, 12, 196, 2, 198, 55, 59, 175, 205, 7, 167, 193, 127, 139, 107, 178, 37, 152, 75, 233, 167, 155, 234, 69, 216, 195, 74, 16, 121, 2, 187, 171, 132, 167 },
                            PasswordSalt = new byte[] { 0, 129, 27, 218, 109, 214, 40, 213, 39, 83, 35, 5, 245, 134, 93, 184, 118, 152, 15, 14, 84, 66, 31, 197, 4, 147, 245, 94, 185, 7, 58, 196, 34, 48, 178, 223, 11, 177, 5, 90, 15, 236, 196, 110, 147, 243, 37, 205, 73, 137, 117, 56, 243, 76, 218, 182, 211, 202, 158, 93, 15, 180, 158, 233, 156, 92, 243, 50, 209, 211, 145, 102, 91, 198, 247, 217, 2, 205, 215, 71, 116, 103, 5, 18, 173, 34, 14, 106, 233, 27, 11, 83, 241, 180, 231, 182, 255, 76, 122, 251, 193, 73, 179, 85, 30, 63, 14, 200, 240, 69, 192, 25, 10, 186, 160, 145, 8, 167, 220, 203, 239, 190, 208, 182, 95, 123, 73, 213 },
                            Reference = "Ben",
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("712d4041-1e09-4380-8373-72385cbc5c9f"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 456,
                            UserId = new Guid("a4e47536-dfb8-42eb-8e17-6cde3acf7a08")
                        });
                });
