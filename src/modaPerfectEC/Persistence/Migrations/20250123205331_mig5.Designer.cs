            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b1008f5a-46be-4e67-9c3e-60c00cfffde2"),
                            Address = "Dere",
                            AuthenticatorType = 0,
                            City = "Konya",
                            Country = "Türkiye",
                            ...
                            LastName = "ÖNCEL",
                            PasswordHash = new byte[] { 35, 23, 40, 74, 96, 117, 173, 45, 223, 35, 153, 225, 68, 28, 145, 56, 85, 197, 58, 203, 76, 40, 235, 188, 152, 35, 5, 160, 227, 136, 73, 133, 176, 192, 4, 196, 167, 34, 245, 52, 18, 210, 90, 161, 176, 175, 65, 6, 214, 192, 151, 29, 110, 165, 75, 62, 240, 76, 126, 40, 95, 182, 95, 226 },
                            PasswordSalt = new byte[] { 152, 110, 16, 182, 82, 149, 87, 51, 117, 9, 229, 253, 166, 135, 169, 255, 104, 177, 153, 47, 27, 160, 129, 70, 82, 164, 249, 35, 176, 48, 226, 134, 243, 118, 6, 253, 78, 3, 103, 207, 53, 112, 181, 35, 215, 68, 211, 74, 60, 191, 143, 254, 132, 51, 99, 61, 131, 206, 192, 107, 228, 24, 22, 183, 174, 52, 149, 188, 225, 191, 92, 158, 182, 46, 193, 183, 59, 124, 165, 240, 37, 74, 209, 164, 4, 30, 235, 85, 254, 224, 117, 16, 181, 25, 21, 213, 78, 254, 84, 30, 212, 51, 215, 74, 92, 195, 223, 109, 127, 77, 159, 123, 45, 24, 223, 54, 242, 16, 56, 113, 116, 252, 213, 4, 179, 178, 126, 226 },
                            Reference = "Ben",
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8cbf9fcc-1f5c-42ae-b460-28aac7c90e31"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 456,
                            UserId = new Guid("b1008f5a-46be-4e67-9c3e-60c00cfffde2")
                        });
                });
