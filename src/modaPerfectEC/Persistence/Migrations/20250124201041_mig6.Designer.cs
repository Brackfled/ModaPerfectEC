            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("99f0fa98-e15f-4a66-8040-caf74ab63ed9"),
                            Address = "Dere",
                            AuthenticatorType = 0,
                            City = "Konya",
                            Country = "Türkiye",
                            ...
                            LastName = "ÖNCEL",
                            PasswordHash = new byte[] { 196, 187, 59, 180, 165, 162, 175, 54, 50, 66, 51, 1, 227, 174, 102, 23, 40, 62, 213, 232, 9, 223, 231, 123, 7, 136, 224, 244, 199, 39, 245, 40, 222, 228, 202, 32, 195, 91, 135, 222, 138, 37, 65, 68, 1, 194, 225, 150, 99, 111, 45, 7, 241, 73, 164, 133, 184, 16, 47, 200, 206, 161, 45, 65 },
                            PasswordSalt = new byte[] { 38, 218, 149, 117, 239, 247, 149, 193, 45, 67, 245, 239, 139, 252, 211, 238, 232, 70, 126, 235, 115, 27, 213, 62, 137, 81, 139, 196, 221, 38, 80, 219, 115, 133, 61, 59, 83, 248, 104, 200, 198, 6, 229, 216, 56, 121, 2, 139, 79, 14, 35, 187, 170, 73, 112, 137, 176, 81, 89, 104, 123, 144, 202, 252, 49, 94, 3, 184, 168, 135, 162, 10, 167, 32, 238, 240, 131, 76, 36, 119, 137, 98, 210, 104, 102, 252, 234, 152, 119, 190, 4, 48, 218, 197, 192, 181, 217, 55, 251, 244, 88, 42, 110, 168, 221, 121, 158, 242, 19, 170, 78, 106, 114, 30, 88, 55, 41, 180, 198, 203, 161, 228, 15, 9, 133, 123, 104, 48 },
                            Reference = "Ben",
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("60627686-30f1-4813-b5a2-79b0c7d09e0a"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 456,
                            UserId = new Guid("99f0fa98-e15f-4a66-8040-caf74ab63ed9")
                        });
                });
