...
namespace Persistence.Migrations
{
    ...
    [Migration("20250203220912_mig10")]
    partial class mig10
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("98472455-cbda-43ed-b1bd-13e37c197e15"),
                            Address = "Dere",
                            AuthenticatorType = 0,
                            City = "Konya",
                            Country = "Türkiye",
                            ...
                            LastName = "ÖNCEL",
                            PasswordHash = new byte[] { 254, 164, 226, 228, 157, 74, 72, 158, 250, 170, 204, 192, 52, 219, 103, 65, 225, 106, 163, 135, 70, 102, 107, 210, 23, 58, 214, 134, 17, 163, 60, 45, 53, 90, 11, 139, 199, 182, 188, 221, 177, 197, 33, 159, 71, 196, 145, 67, 122, 146, 6, 110, 198, 44, 57, 195, 168, 255, 2, 236, 147, 11, 241, 83 },
                            PasswordSalt = new byte[] { 83, 42, 67, 114, 69, 52, 79, 210, 155, 198, 117, 148, 190, 240, 48, 186, 160, 82, 178, 123, 2, 216, 184, 212, 44, 82, 24, 202, 157, 206, 245, 211, 41, 247, 28, 181, 248, 89, 249, 142, 39, 10, 207, 155, 81, 90, 3, 118, 171, 149, 238, 122, 187, 65, 87, 37, 248, 10, 21, 48, 203, 106, 151, 138, 24, 233, 180, 123, 164, 150, 136, 14, 190, 17, 170, 71, 142, 167, 16, 249, 176, 172, 40, 19, 61, 230, 215, 61, 114, 160, 227, 177, 211, 125, 248, 126, 73, 239, 67, 52, 6, 125, 9, 7, 32, 221, 111, 48, 222, 53, 196, 52, 34, 246, 236, 166, 11, 60, 224, 97, 5, 26, 32, 237, 214, 209, 99, 216 },
                            Reference = "Ben",
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5218f916-c93b-42a5-b9b8-902d9e3b42e8"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 456,
                            UserId = new Guid("98472455-cbda-43ed-b1bd-13e37c197e15")
                        });
                });
