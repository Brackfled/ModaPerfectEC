...
namespace Persistence.Migrations
{
    ...
    [Migration("20250204212408_mig11")]
    partial class mig11
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("71f5c21f-c9d6-4c0e-9846-9164de986e02"),
                            Address = "Dere",
                            AuthenticatorType = 0,
                            City = "Konya",
                            Country = "Türkiye",
                            ...
                            LastName = "ÖNCEL",
                            PasswordHash = new byte[] { 102, 162, 239, 59, 67, 108, 117, 18, 35, 210, 72, 131, 191, 115, 71, 6, 254, 96, 223, 175, 123, 75, 121, 158, 224, 40, 73, 73, 126, 101, 210, 204, 233, 28, 237, 175, 217, 53, 96, 21, 14, 54, 247, 102, 3, 231, 13, 149, 33, 79, 49, 254, 159, 68, 27, 105, 122, 180, 72, 156, 246, 216, 175, 33 },
                            PasswordSalt = new byte[] { 8, 133, 54, 154, 186, 29, 172, 178, 34, 125, 74, 218, 177, 253, 136, 0, 186, 22, 232, 96, 157, 172, 114, 82, 92, 22, 101, 134, 57, 55, 139, 96, 218, 165, 19, 211, 250, 37, 238, 48, 108, 206, 8, 72, 83, 109, 202, 0, 92, 198, 110, 60, 97, 119, 224, 240, 139, 41, 148, 22, 204, 200, 214, 145, 16, 36, 137, 222, 249, 192, 82, 138, 172, 13, 134, 93, 115, 122, 186, 34, 231, 40, 225, 82, 232, 41, 79, 102, 15, 32, 90, 18, 127, 164, 196, 159, 126, 192, 192, 153, 63, 146, 125, 127, 236, 8, 95, 152, 255, 121, 252, 217, 52, 44, 68, 196, 158, 186, 110, 130, 253, 115, 159, 27, 150, 185, 11, 10 },
                            Reference = "Ben",
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a5798b83-9fe3-49d1-b3e6-1c51bbbf331c"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 456,
                            UserId = new Guid("71f5c21f-c9d6-4c0e-9846-9164de986e02")
                        });
                });
