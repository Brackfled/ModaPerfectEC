...
namespace Persistence.Migrations
{
    ...
    [Migration("20250209111138_mig13")]
    partial class mig13
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f099f6d7-2879-4f89-8029-7bbb6ebef1e6"),
                            Address = "Dere",
                            AuthenticatorType = 0,
                            City = "Konya",
                            Country = "Türkiye",
                            ...
                            LastName = "ÖNCEL",
                            PasswordHash = new byte[] { 139, 5, 18, 202, 62, 185, 244, 75, 154, 180, 157, 170, 155, 51, 19, 36, 62, 153, 182, 120, 203, 2, 158, 201, 4, 216, 185, 204, 226, 82, 170, 230, 172, 79, 173, 65, 50, 74, 237, 107, 249, 201, 121, 214, 34, 56, 153, 158, 246, 150, 103, 44, 77, 141, 190, 195, 232, 201, 193, 236, 123, 208, 39, 119 },
                            PasswordSalt = new byte[] { 200, 87, 211, 196, 91, 251, 128, 197, 15, 253, 171, 241, 187, 58, 145, 236, 122, 61, 23, 4, 176, 7, 37, 120, 181, 121, 224, 130, 160, 158, 89, 235, 9, 30, 47, 107, 201, 79, 7, 242, 0, 139, 166, 229, 18, 76, 2, 213, 32, 233, 20, 246, 82, 127, 166, 16, 102, 55, 224, 33, 125, 213, 13, 126, 26, 73, 197, 207, 103, 16, 147, 60, 237, 22, 59, 108, 91, 44, 142, 5, 79, 206, 210, 80, 61, 249, 111, 209, 122, 140, 45, 151, 192, 240, 37, 90, 76, 226, 199, 86, 129, 75, 40, 248, 180, 171, 129, 140, 164, 92, 0, 106, 85, 227, 255, 158, 13, 221, 122, 237, 171, 44, 30, 12, 135, 56, 36, 148 },
                            Reference = "Ben",
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4ef56511-c4ff-4874-95e3-ceb39f8c0e5c"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 456,
                            UserId = new Guid("f099f6d7-2879-4f89-8029-7bbb6ebef1e6")
                        });
                });
