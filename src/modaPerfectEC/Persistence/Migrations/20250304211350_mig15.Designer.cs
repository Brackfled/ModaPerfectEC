...
namespace Persistence.Migrations
{
    ...
    [Migration("20250304211350_mig15")]
    partial class mig15
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 528,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "ProductReturns.Admin"
                        },
                        new
                        {
                            Id = 529,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "ProductReturns.Read"
                        },
                        new
                        {
                            Id = 530,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "ProductReturns.Write"
                        },
                        new
                        {
                            Id = 531,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "ProductReturns.Create"
                        },
                        new
                        {
                            Id = 532,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "ProductReturns.Update"
                        },
                        new
                        {
                            Id = 533,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "ProductReturns.Delete"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProductReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f92e3b75-e962-436d-b8b8-33256d16df81"),
                            Address = "Dere",
                            AuthenticatorType = 0,
                            City = "Konya",
                            Country = "Türkiye",
                            ...
                            LastName = "ÖNCEL",
                            PasswordHash = new byte[] { 2, 202, 203, 115, 179, 253, 130, 208, 110, 36, 176, 137, 110, 57, 37, 14, 105, 26, 28, 254, 169, 158, 159, 221, 56, 137, 149, 247, 236, 97, 61, 170, 117, 96, 83, 169, 199, 152, 84, 7, 157, 23, 176, 108, 103, 101, 134, 219, 84, 105, 123, 109, 25, 66, 109, 73, 187, 84, 129, 253, 122, 187, 191, 74 },
                            PasswordSalt = new byte[] { 172, 176, 41, 182, 62, 144, 135, 103, 128, 143, 5, 84, 98, 97, 139, 63, 25, 112, 121, 207, 101, 20, 250, 129, 220, 107, 87, 78, 66, 101, 254, 152, 38, 184, 107, 147, 13, 107, 155, 64, 70, 4, 181, 148, 136, 217, 239, 36, 128, 217, 192, 34, 58, 16, 42, 87, 234, 198, 214, 178, 190, 144, 251, 30, 200, 205, 193, 20, 162, 29, 94, 177, 98, 234, 242, 94, 133, 108, 96, 127, 207, 233, 57, 142, 164, 1, 116, 189, 147, 4, 241, 76, 42, 161, 74, 80, 92, 135, 204, 7, 99, 240, 148, 152, 44, 124, 106, 29, 57, 74, 159, 201, 92, 242, 192, 40, 236, 162, 119, 91, 2, 152, 216, 28, 203, 158, 45, 142 },
                            Reference = "Ben",
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9cdfeb67-e175-490c-8fe5-23b7374b1a2b"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 456,
                            UserId = new Guid("f92e3b75-e962-436d-b8b8-33256d16df81")
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ReturnImage", b =>
                {
                    b.HasBaseType("Domain.Entities.MPFile");
                    ...
                    b.HasDiscriminator().HasValue("ReturnImage");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ReturnImage", b =>
                {
                    b.HasOne("Domain.Entities.ProductReturn", "ProductReturn")
